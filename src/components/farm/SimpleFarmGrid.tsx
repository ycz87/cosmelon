...
export function SimpleFarmGrid({
  ...
  const plotScale = compactMode
    ? (isCompactMobile ? 1.3 : isMobile ? 1.34 : 1.42)
    : 1;
  ...
  const sceneTopPadding = compactMode
    ? (isCompactMobile
      ...
      : isMobile
        ? Math.round(effectivePlotSize * 1.58)
  ...
  const slotOffsetScale = compactMode
    ? (isCompactMobile ? 1.02 : isMobile ? 1.05 : 1.04)
        ...
        >
          <div
            ...
            style={{
              ...
              gridAutoRows: `${Math.round(effectivePlotSize * (compactMode ? (isMobile ? 0.8 : 0.68) : 0.56))}px`,
            }}
          >
