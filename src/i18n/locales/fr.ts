...
export const fr: Messages = {
  ...
  collectionUnlockHint: (id) => ({
    'flame-crystal': 'Collectez 5 variétés Étoile Bleue pour débloquer',
    'frost-moon': 'Collectez toutes les variétés Étoile Bleue pour débloquer',
    'rainbow': 'Collectez 15 variétés pour débloquer',
    'dark-matter': 'Collectez 20 variétés pour débloquer',
  }[id] ?? 'Bientôt'),
  galaxyName: (id) => ({
    'blue-star': 'Étoile Bleue (Terre)',
    'flame-crystal': 'Cristal de Flamme',
    'frost-moon': 'Lune Givrée',
    'rainbow': 'Arc-en-ciel',
  ...
  varietyStory: (id) => ({
    'jade-stripe': 'La pastèque classique — peau verte, rayures blanches',
    'black-pearl': 'Le secret le plus doux se cache sous sa peau noire',
    'honey-bomb': 'Si sucrée qu\'elle explose ! Une bouchée et vous êtes sucré trois jours',
    'mini-round': 'Mignonne comme tout, tient dans la paume',
    'star-moon': 'Des motifs de lune et d\'étoiles poussent naturellement sur sa peau bleu foncé',
    'golden-heart': 'Chair dorée à l\'intérieur, comme un trésor caché',
    'ice-sugar-snow': 'Chair blanche qui fond sur la langue — ne fructifie qu\'à la première neige',
    'cube-melon': 'Un miracle qui pousse naturellement en carré — uniquement sur Terre',
  }[id] ?? ''),
};
