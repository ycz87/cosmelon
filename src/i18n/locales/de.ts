...
export const de: Messages = {
  ...
  collectionUnlockHint: (id) => ({
    'flame-crystal': '5 Blauer-Stern-Sorten sammeln zum Freischalten',
    'frost-moon': 'Alle Blauer-Stern-Sorten sammeln zum Freischalten',
    'rainbow': '15 Sorten sammeln zum Freischalten',
    'dark-matter': '20 Sorten sammeln zum Freischalten',
  }[id] ?? 'Demnächst'),
  galaxyName: (id) => ({
    'blue-star': 'Blauer Stern (Erde)',
    'flame-crystal': 'Flammenkristall',
  ...
  varietyStory: (id) => ({
    'jade-stripe': 'Die klassische Wassermelone — grüne Schale, weiße Streifen',
    'black-pearl': 'Das süßeste Geheimnis verbirgt sich unter der schwarzen Schale',
    'honey-bomb': 'So süß, dass es explodiert! Ein Biss und du bist drei Tage süß',
    'mini-round': 'Handflächengroßer Liebling, perfekt für eine Person',
    'star-moon': 'Mond- und Sternmuster wachsen natürlich auf der tiefblauen Schale',
    'golden-heart': 'Goldenes Fruchtfleisch, wie ein versteckter Schatz',
    'ice-sugar-snow': 'Weißes Fruchtfleisch, schmilzt auf der Zunge — nur beim ersten Schnee',
    'cube-melon': 'Ein Wunder, das natürlich quadratisch wächst — nur auf der Erde',
  }[id] ?? ''),
};
