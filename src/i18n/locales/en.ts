...
export const en: Messages = {
  ...
  itemName: (id) => ({
    ...
    'supernova-bottle': '☀️ Supernova Bottle',
  ...
  collectionUnlockHint: (id) => ({
    'flame-crystal': 'Collect 5 Blue Star varieties to unlock',
    'frost-moon': 'Collect all Blue Star varieties to unlock',
    'rainbow': 'Collect 15 varieties to unlock',
    'dark-matter': 'Collect 20 varieties to unlock',
  }[id] ?? 'Coming soon'),
  galaxyName: (id) => ({
    'blue-star': 'Blue Star (Earth)',
    'flame-crystal': 'Flame Crystal',
  ...
  varietyStory: (id) => ({
    'jade-stripe': 'The classic watermelon — green skin, white stripes, every farmer\'s old friend',
    'black-pearl': 'The sweetest secret hides beneath its dark black skin',
    'honey-bomb': 'So sweet it explodes! One bite and you\'re sweet for three days',
    'mini-round': 'Palm-sized cutie, perfect for one person',
    'star-moon': 'Moon and star patterns naturally grow on its deep blue skin',
    'golden-heart': 'Golden flesh inside, like hidden treasure',
    'ice-sugar-snow': 'White flesh that melts on your tongue — only fruits during first snow',
    'cube-melon': 'A miracle that grows naturally square — only on Earth',
  }[id] ?? ''),
};
