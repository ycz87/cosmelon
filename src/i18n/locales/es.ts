...
export const es: Messages = {
  ...
  collectionUnlockHint: (id) => ({
    'flame-crystal': 'Colecciona 5 variedades de Estrella Azul para desbloquear',
    'frost-moon': 'Colecciona todas las variedades de Estrella Azul para desbloquear',
    'rainbow': 'Colecciona 15 variedades para desbloquear',
    'dark-matter': 'Colecciona 20 variedades para desbloquear',
  }[id] ?? 'Próximamente'),
  galaxyName: (id) => ({
    'blue-star': 'Estrella Azul (Tierra)',
    'flame-crystal': 'Cristal de Llama',
    'frost-moon': 'Luna Helada',
    'rainbow': 'Arcoíris',
