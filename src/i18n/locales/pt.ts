...
export const pt: Messages = {
  ...
  hybridDexTitle: 'Enciclopédia de variedades híbridas',
  ...
  varietyName: (id) => ({
    ...
    'lava-field': 'Melão Campo de Lava',
    'volcanic-ash': 'Melão Cinza Vulcânica',
    'earth-core': 'Melão Núcleo da Terra',
    'hot-spring': 'Melão Fonte Termal',
    'mud-pool': 'Melão Poça de Lama',
    oasis: 'Melão Oásis',
    'ancient-root': 'Melão Raiz Ancestral',
    fossil: 'Melão Fóssil',
    'earth-mother': 'Melão Mãe-Terra',
    'ore-vein': 'Melão Veio de Minério',
    amber: 'Melão Âmbar',
    gemstone: 'Melão Pedra Preciosa',
    steam: 'Melão Vapor',
    geyser: 'Melão Gêiser',
    mist: 'Melão Névoa',
    wildfire: 'Melão Fogo Selvagem',
    'ash-bloom': 'Melão Flor de Cinzas',
    'fire-seed': 'Melão Semente de Fogo',
    forge: 'Melão Forja',
    'molten-iron': 'Melão Ferro Fundido',
    'solar-furnace': 'Melão Fornalha Solar',
    rainforest: 'Melão Floresta Tropical',
    lotus: 'Melão Lótus',
    dewdrop: 'Melão Gota de Orvalho',
    'ice-blade': 'Melão Lâmina de Gelo',
    mirror: 'Melão Espelho',
    'mercury-spring': 'Melão Fonte de Mercúrio',
    'golden-leaf': 'Melão Folha Dourada',
    'iron-tree': 'Melão Árvore de Ferro',
    'mech-vine': 'Melão Trepadeira Mecânica',
  }[id] ?? id),
  varietyStory: (id) => ({
  ...
  geneInjectTitle: 'Injeção genética',
  geneInjectDesc: 'Injete um fragmento genético em uma semente para mirar uma galáxia específica',
  geneInjectSelectGalaxy: 'Selecionar gene da galáxia',
  geneInjectSelectSeed: 'Selecionar qualidade da semente',
  geneInjectButton: '🧬 Injetar',
  geneInjectSuccess: 'Injeção bem-sucedida! Semente injetada obtida',
  geneInjectNoFragments: 'Sem fragmentos genéticos',
  geneInjectNoSeeds: 'Sem sementes',
  geneInjectCost: 'Custo: 1 fragmento genético + 1 semente',
  injectedSeedLabel: (galaxyName) => `🧬 Semente injetada (${galaxyName})`,
  injectedSeedHint: 'Semente injetada: 80% de chance de variedade da galáxia alvo',
  hybridSeedHint: 'Semente híbrida: cultiva uma variedade do par de galáxias selecionado',
  geneFusionTitle: 'Fusão de duplo elemento',
  geneFusionDesc: 'Funda fragmentos genéticos de duas galáxias diferentes para criar sementes híbridas',
  geneFusionSelectFirst: 'Selecione o primeiro gene de galáxia',
  geneFusionSelectSecond: 'Selecione o segundo gene de galáxia (deve ser diferente)',
  geneFusionRate: (rate) => `Taxa de sucesso: ${Math.round(rate * 100)}%`,
  geneFusionButton: '🧬 Fundir',
  geneFusionSuccess: 'Fusão bem-sucedida! Semente híbrida obtida',
  geneFusionFail: 'A fusão falhou, genes consumidos',
  geneFusionSameGalaxy: 'É preciso selecionar genes de galáxias diferentes',
  geneFusionNoFragments: 'Fragmentos genéticos insuficientes',
  hybridSeedLabel: (pairName) => `🧬 Semente híbrida (${pairName})`,
  hybridGalaxyPairLabel: (pair) => ({
    'earth-fire': '🌍+🔥 Terra-Fogo',
    'earth-water': '🌍+💧 Terra-Água',
    'earth-wood': '🌍+🌿 Terra-Madeira',
    'earth-metal': '🌍+✨ Terra-Metal',
    'fire-water': '🔥+💧 Fogo-Água',
    'fire-wood': '🔥+🌿 Fogo-Madeira',
    'fire-metal': '🔥+✨ Fogo-Metal',
    'water-wood': '💧+🌿 Água-Madeira',
    'water-metal': '💧+✨ Água-Metal',
    'wood-metal': '🌿+✨ Madeira-Metal',
  }[pair] ?? pair),
